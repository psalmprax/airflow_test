select
	...
	convert(decimal(15,2),case charge when '' then 0.00 else charge end) as charge,
	convert(decimal(15,2),case paid_amount when '' then 0.00 else paid_amount end) as paid_amount,
