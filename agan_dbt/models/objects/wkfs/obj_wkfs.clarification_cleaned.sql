with results as (
 select
	...
	convert(decimal(15,2), case donation_amount when '' then null else donation_amount end) as donation_amount,
	convert(decimal(15,2), case calculated when '' then null else calculated end) as calculated,
