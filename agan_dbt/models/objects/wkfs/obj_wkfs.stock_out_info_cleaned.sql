select
	...
	convert(numeric, case price when '' then null else price end) as price,
	convert(numeric, case shippingcosts when '' then null else shippingcosts end) as shippingcosts,
